...
function createRender(options) {
    var hostCreateElement = options.createElement, hostPatchProps = options.patchProps, hostInsert = options.insert;
...
var renderer = createRender({ createElement: createElement, patchProps: patchProps, insert: insert });
function createApp() {
    var args = [];
